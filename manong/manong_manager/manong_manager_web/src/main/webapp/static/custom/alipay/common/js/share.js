var shareico = {
    ...
    "qqfriend":"http://connect.qq.com/widget/shareqq/index.html?url={url}&title={title}"
};
var shareiconame = {
    "tqq": "腾讯微博",
    "tsina": "新浪微博",
...
$(document).ready(function () {
    $('.bdsharedabuttons a').each(function () {
        var str = $(this).attr("data-cmd");
        if (str !== undefined) {
            var share_url = formatmodel(shareico[str], {title: title, url: url});
